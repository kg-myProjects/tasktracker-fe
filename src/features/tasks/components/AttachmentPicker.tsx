...
export const AttachmentPicker = ({ taskId, isUpdating, onClose, onPatchTask, currentAttachments }: AttachmentPickerProps) => {
    ...
    return (
        <div onClick={e => e.stopPropagation()} className="w-[350px] bg-white border-2 border-cyan-400 rounded-3xl shadow-2xl p-6 z-[100] mt-2 fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 animate-in slide-in-from-right-4">
