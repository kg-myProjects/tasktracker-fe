    ...
    return (
        <div className="flex items-center gap-2">
            ...
            <div className="relative flex items-center justify-center w-8 h-8 md:w-16 md:h-16 transition-all duration-500 hover:scale-[1.1]">
                ...
                >
                    <circle cx="12" cy="12" r="10" className="stroke-accent opacity-70" strokeWidth="1" strokeDasharray="4 4" />
                </svg>
                <svg
                    viewBox="0 0 24 24"
                    fill="none"
                ...
                >
                    <circle cx="12" cy="12" r="8" className="stroke-accent opacity-90" strokeWidth="2" />
                    <path d="M12 8V12M12 12H16M12 12V16M12 12H8" className="stroke-accent" strokeWidth="2" strokeLinecap="round" />
            ...
            <span className="flex items-baseline text-xl md:text-4xl tracking-tighter drop-shadow-[0_0_10px_rgba(6,182,212,1)] transition-all duration-500 hover:scale-[1.1]">
                ...
                <span className="text-accent font-black hover:text-white transition-all duration-500">
                    App
                </span>
            </span>
        </div>
